...
{
    public class StereoRgbCalibration
    {
        //chessboard params
        ...
        //Frames
        Image<Bgr, Byte> processFrameS1;
        Image<Bgr, Byte> processFrameS2;
        ...
        {
            Image<Bgr, byte> disparityMapResult = null;
            #region FrameAquissition
            processFrameS1 = frameS1;
            processFrameS2 = frameS2;
            #endregion
            ...
            if (currentMode == Mode.SavingFrames)
            {
                ...
                bool paternFoundLeftImg = CvInvoke.FindChessboardCorners(processFrameS1, patternSize, pointMatrixLeftCorners, Emgu.CV.CvEnum.CalibCbType.AdaptiveThresh);
                bool paternFoundRightImg = CvInvoke.FindChessboardCorners(processFrameS2, patternSize, pointMatrixRightCorners, Emgu.CV.CvEnum.CalibCbType.AdaptiveThresh);
                ...
                if (this.leftCorners != null && rightCorners != null)
                {
                    ...
                    processFrameS1.FindCornerSubPix(new PointF[1][] { leftCorners }, new Size(11, 11), new Size(-1, -1), new MCvTermCriteria(30, 0.01));
                    processFrameS2.FindCornerSubPix(new PointF[1][] { rightCorners }, new Size(11, 11), new Size(-1, -1), new MCvTermCriteria(30, 0.01));
                    if (startFlag)
                    {
            ...
            if (currentMode == Mode.Calibrated)
            {
                ...
                Image<Bgr, byte> disparityMap;
                Computer3DPointsFromStereoPair(processFrameS1, processFrameS2, out disparityMap, out _points);
        ...
        private void Computer3DPointsFromStereoPair(Image<Bgr, Byte> left, Image<Bgr, Byte> right, out Image<Bgr, Byte> disparityMap, out MCvPoint3D32f[] points)
        {
            disparityMap = null;
            points = null;
            try
            {
                ...
                disparityMap = new Image<Bgr, Byte>(size);
